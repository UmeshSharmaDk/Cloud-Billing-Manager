...
router.post("/", requireAuth, requireBusiness, validateBody(CreateCustomerBody), async (req: any, res) => {
  const businessId = req.businessId;
...
router.patch("/:id", requireAuth, requireBusiness, validateParams(IdParam), validateBody(UpdateCustomerBody), async (req: any, res) => {
  const businessId = req.businessId;
